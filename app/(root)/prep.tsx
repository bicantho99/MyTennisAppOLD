...
export default function Logs() {
  ...
  const switchComponent = () => {
    switch (selected) {
      ...
      default:
        return (
          <TouchableOpacity onPress={() => router.push("/(journal)/matchpage")}>
            <View className="bg-slate-800 pl-5 pr-3 pt-2 border-blue-800 border-dash rounded-xl gap-[9px] border-[0.4px] h-[150px] mb-4  shadow-sm shadow-slate-300 ">
              <View className="justify-between"></View>
              ...
              <View className="gap-2">
                <Text className="text-slate-400 text-[14px]">Match notes:</Text>
    ...
    <SafeAreaView className="bg-bgColor flex-1">
      <View className="mx-6 ">
        <View className="flex-row justify-between items-center">
          ...
          <TouchableOpacity
            onPress={() =>
              router.push(!toggle ? "/(edit)/matches" : "/(edit)/tourney")
            }
          >
            <AntDesign
              name="pluscircle"
