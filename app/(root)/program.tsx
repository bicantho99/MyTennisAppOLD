    ...
    <SafeAreaView className="flex-1 bg-bgColor">
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="mx-6 my-2 ">
            ...
            <View className="text-view flex-col justify-between h-full">
              ...
              <View className="mt-8 gap-2 m">
                ...
                <View className="flex-row justify-between">
                  <Text className="text-textColor mt-2">Coach Cecile</Text>
                </View>
              </View>
          ...
          >
            <View className="box-view  bg-slate-800 pl-5  pr-3 pt-5  border-slate-300 rounded-xl gap-[5px]   border-[0.4px]  h-[165px] mb-4">
              <View className="text-view gap-2">
                ...
                <View className="mt-8 gap-2">
                  ...
                  <Text className="text-textColor mt-5">Total Weeks: 3</Text>
                </View>
              </View>
            </View>
          </TouchableOpacity>
