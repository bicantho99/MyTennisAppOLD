    ...
    <SafeAreaView style={{ flex: 1 }} className="bg-bgColor">
      ...
      >
        ...
        <View className="mx-6 my-6">
          ...
          <View className="box-view  bg-slate-800 pl-5  pr-3 pt-5  border-blue-800 rounded-xl gap-[5px]   border-[0.4px]  h-[190px]">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <Text className="text-[15px] font-semibold">{item.text}</Text>
                        </View>
                      </Animated.View>
                    );
                  }}
