    ...
    <SafeAreaView style={{ flex: 1 }} className="bg-bgColor">
      <ScrollView>
        <View className="mx-6 my-6">
          ...
          <View className="box-view box-border bg-gray-800 pl-4 pr-3 pt-5 rounded-xl gap-[5px] border-[0.4px] h-[210px]">
            <View className="text-view gap-2">
              <Text className="text-blue-300 font-bold text-[20px] mb-2 ml-2">
                Weekly's Challenge
              </Text>
              <View className="mb-2 mt-1 ml-2">
                <Progress.Bar
                  progress={progress}
                  width={300}
                  animated={true}
            ...
            <View className="">
              ...
              >
                {challenges.map((challenge, index) => (
                  ...
                  >
                    <View
                      className="bg-blue-400 rounded-md gap-3 p-3 my-3"
                        ...
                        <Checkbox
                          ...
                          onValueChange={() => {
                            if (completedTasks.includes(index)) {
                              setCompletedTasks(
                                completedTasks.filter((task) => task !== index)
                              ); // Uncheck logic
                            } else {
                              ...
                              if (index < challenges.length - 1) {
                                ...
                                }, 300); // Delay to visually confirm the check
                              }
                            }
                          }}
                          color={
                            completedTasks.includes(index) ? "#4ADE80" : "black"
                          }
                        />
                      </View>
              ...
              <View
                className="flex-row gap-1 justify-center items-center mt-3"
                ...
                {challenges.map((_, index) => (
                  <View
                    ...
                    style={{
                      ...
                      backgroundColor:
                        index === currentTask ? "white" : "#60A5FA",
                      borderRadius: 2,
                      marginHorizontal: 3,
                    }}
                  />
